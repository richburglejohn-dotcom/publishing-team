...
**Not yet done for any episode's clips:** pairing these audio-only clips with a visual for Instagram/TikTok posting (per the standing note in this doc's original status line — "a static image works, these aren't native video").
