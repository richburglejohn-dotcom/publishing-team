...
### Created: 2026-07-18 | Rewritten to author-voice 2026-08-22, then restored 2026-09-12 for the full reversal back to Baron-AI-hosted
### Read-aloud script for TTS / voice-clone — Baron Vieux's AI voice

**Status (2026-09-12): Full reversal decided.** The show goes back to Baron hosting in-character, per Lejohn's direction after trialing the new ElevenLabs voice below on the Dark Roux interlude. This restores the original Baron-voice version of this script (recovered from git history, commit `a0f146c~1`) over the author-voice rewrite that was actually produced and filed at `outputs/podcast-ep1-baron-origin-FULL.mp3` (12.93 min, 2026-08-24). **That audio is now superseded and needs to be regenerated from this script** — not yet done, flagged as the next production step.

**Voice:** "Baron Vieux American" (ElevenLabs, voice_id `4gMxHJqo0nJJd3aeKX6z`), added by Lejohn 2026-09-12 — a new clone, distinct from the older Flow-only `@Voice: Charon` reference used for on-camera video. Record any further voice-ID changes in `references/baron-vieux-voice-reference-master-v1.md`, the canonical reference.
...
- This script does **not** include the author's spoken disclosure — that's a separate short recording, in Lejohn's real voice, that plays before this episode starts (per `outputs/culinary-crescendo-podcast-concept-v1.md` and `outputs/podcast-disclosure-spoken-script-v1.md`). Don't fold it into Baron's track.
