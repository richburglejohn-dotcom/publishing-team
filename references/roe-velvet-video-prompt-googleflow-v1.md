...
- **Scene 5 keeper confirmed (2026-09-02):** `references/roe-velvet-scene5-quenelle-v1.mp4` — beaded roe texture and colors correct, two near-identical takes generated, this one filed as keeper. Both takes included an unscripted, heavily out-of-focus food plate in the background (Flow's own addition, not in the prompt) — not treated as a hard-fail since it's fully out of focus and doesn't misrepresent the dish itself.
